...
| computer.jpg | hexeditor | `hexeditor computer.jpg` | <img src="Screenshot 2026-04-10 231318.png" width="300"/> | Checked file header in hex. Can see real structure and detect if file is modified. |
...
| rubiks.jpg | file | `file rubiks.jpg` | <img src="Screenshot 2026-04-10 234820.png" width="300"/> | File type not match extension. Actually PNG, not JPG. |
