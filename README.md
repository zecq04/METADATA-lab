...
| computer.jpg | hexeditor | https://hexed.it/<br>`hexeditor computer.jpg` | <img src="Screenshot 2026-04-11 100956.png" width="300"/><br><img src="Screenshot 2026-04-10 233606.png" width="300"/> | Checked file header in hex. Can see real structure and detect if file is modified. |
...
| solitaire.exe | file | `file solitaire.exe` | <img src="Screenshot 2026-04-10 231318.png" width="300"/> | Not an exe file. It is actually an image (PNG). |
